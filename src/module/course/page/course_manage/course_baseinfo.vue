  ...
  <div>
    <el-form :model="courseForm" label-width="80px" :rules="courseRules" ref="courseForm">
      <el-form-item label="课程名称" prop="name">
        <el-input v-model="courseForm.name" auto-complete="off" :disabled="true" ></el-input>
      </el-form-item>
      <el-form-item label="适用人群" prop="users">
        <el-input type="textarea" v-model="courseForm.users" auto-complete="off" :disabled="true" ></el-input>
      </el-form-item>
      ...
      <el-form-item label="课程等级" prop="grade">
        <b v-for="grade in gradeList">
          <el-radio :disabled="true" v-model="courseForm.grade" :label="grade.sdId" >{{grade
              .sdName}}</el-radio>&nbsp;&nbsp;
        </b>
      </el-form-item>
      <el-form-item label="学习模式" prop="studymodel">
        <b v-for="studymodel_v in studymodelList">
          <el-radio :disabled="true" v-model="courseForm.studymodel" :label="studymodel_v.sdId" >{{studymodel_v
              .sdName}}</el-radio>&nbsp;&nbsp;
        </b>
      ...
      <el-form-item label="课程介绍" prop="description">
        <el-input :disabled="true" type="textarea" v-model="courseForm.description" ></el-input>
      </el-form-item>
...
//        console.log(res);
      ...
      courseApi.category_findlist({}).then((res) => {
        this.categoryList = res[0].children;
      });
      //查询课程信息
        //课程id
